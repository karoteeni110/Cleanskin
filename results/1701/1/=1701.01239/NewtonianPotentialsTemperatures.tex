...
\bibitem{Hawking3} S.W. Hawking, {\it Particle Creation by Black Holes}, Commun. Math. Phys. {\bf 43}, 199 (1975).

\bibitem{LIGO} B.P. Abbott (LIGO Scientific Collaboration and Virgo Collaboration) et al., \textit{Observation of Gravitational Waves from a Binary Black Hole Merger}, Phys. Rev. Lett. {\bf 116}, 061102 (2016); arxiv:1602.03837.

\bibitem{Bekenstein} J.D. Bekenstein, {\it Black Holes and Entropy}, Phys. Rev. D {\bf 7}, 2333 (1973); {\it Generalized second law of thermodynamics in black-hole physics}, Phys. Rev. D {\bf 9}, 3292 (1974).

\bibitem{Hawking1} S.W. Hawking, {\it Breakdown of Predictability in Gravitational Collapse}, Phys. Rev. D {\bf 14}, 2460 (1976).

\bibitem{Hawking2} S.W. Hawking, {\it The Information Paradox for Black Holes}, arXiv:1509.01147.

\bibitem{Jacobson1} T. Jacobson, {\it Thermodynamic of Spacetime: The Einstein Equation of State}, Phys. Rev. Lett. {\bf 75} (1995) 1260-1263.

\bibitem{Jacobson2} T. Jacobson, \textit{Entanglement Equilibrium and the Einstein Equation}, Phys. Rev. Lett. {\bf 116} (2016) 201101; arXiv:1505.04753 [gr-qc].

\bibitem{Jacobson3} C. Eling, R. Guedens, and T. Jacobson, \textit{Non-equilibrium Thermodynamics of Spacetime}, Phys. Rev. Lett. \textbf{96}, 121301 (2006); arXiv:0602001 [gr-qc].

\bibitem{Jacobson4} R. Guedens, T. Jacobson, and S. Sarkar, \textit{Horizon entropy for higher curvature equations of state}, Phys. Rev. D \textbf{85}, 064017 (2012); arXiv:1112.6215 [gr-qc].

\bibitem{VanRaamsdonk} N. Lashkari, M.B. McDermott, and M. Van Raamsdonk, {\it Gravitational dynamics from entanglement `thermodynamics'}, JHEP 1404 (2014) 195; arXiv:1308.3716 [hep-th].\\
...
\bibitem{Verlinde} E. Verlinde, {\it On the Origin of Gravity and the Laws of Newton}, JHEP 1104 (2011) 029; arXiv:1001.0785 [hep-th].

\bibitem{MOR} A. Mart\'inez-Merino, O. Obreg\'on, and M. Ryan, arXiv:1611.09654 [gr-qc].

\bibitem{RovAsh} C. Rovelli, \textit{Black Hole Entropy from Loop Quantum Gravity}, Phys. Rev. Lett. {\bf 77} (1996) 3288.\\
A. Ashtekar, J. Baez, A. Corichi, and K. Krasnov, \textit{Quantum Geometry and Black Hole Entropy}, Phys. Rev. Lett. {\bf 80} (1998) 904.

\bibitem{ModestoRandono} L. Modesto, and A. Randono, \textit{Entropic corrections to Newton's law}; arXiv:1003.1998 [hep-th].

\bibitem{OST} O. Obreg\'on, M. Sabido, and V.I. Tkach, \textit{Entropy Using Path Integrals for Quantum Black Hole Models}, Gen. Rel. Grav. {\bf 33}, 913-919 (2001); arXiv:0003023 [gr-qc].

\bibitem{LOSR} J.C. L\'opez-Dom\'inguez, O. Obreg\'on, M. Sabido, and C. Ramirez, \textit{Towards noncommutative quantum black holes}, Phys. Rev. D {\bf 74} (2006) 084024; arXiv:0607002 [hep-th].

\bibitem{Fursaev} D.V. Fursaev, \textit{Temperature and entropy of a quantum black hole and conformal anomaly}, Phys. Rev. D {\bf 51} R5352 (1995).

\bibitem{Sheykhi} A. Sheykhi, {\it Entropic Corrections to Friedmann Equations}, Phys. Rev. D {\bf 81} (2010) 104011; arXiv:1004.0627 [gr-qc].

\bibitem{Frampton} D.A. Easson, P.H. Frampton, and G.F. Smoot, {\it Entropic accelerating universe}, Phys. Lett. B {\bf 696}, 273-277 (2011); arXiv:1002.4278 [hep-th]; {\it Entropic Inflation}, Int. J. Mod. Phys. A {\bf 27}, 1250066 (2012); arXiv:1003.1528 [hep-th].

\bibitem{Kiefer} C. Kiefer, {\it Quantum Gravity}, Oxford University Press, Oxford New York 3rd. Ed. (2012).

\bibitem{BeckCohen} C. Beck, and E.G.D. Cohen, {\it Superstatistics}, Physica A {\bf 322}, 267-275 (2003).

\bibitem{Tsallis1} C. Tsallis, {\it Possible Generalization of Boltzmann-Gibbs Statistics}, J. Stat. Phys. {\bf 52}, 479 (1988).

\bibitem{Obregon1} O. Obreg\'on, {\it Superstatistics and Gravitation}, Entropy {\bf 12}, 2067-2076 (2010).

\bibitem{Obregon2} O. Obreg\'on, and A. Gil-Villegas, {\it Generalized information entropies depending only on the probability distribution}, Phys. Rev. E {\bf 88}, 062146 (2013).

\bibitem{Tsallis2} Since there are many applications of this entropy, we think it is more convenient to cite the Wikipedia page $https://en.wikipedia.org/wiki/Tsallis\_entropy$, where there is an extensive bibliography covering the phenomena we mention.

\bibitem{Obregon3} O. Obreg\'on, {\it Generalized information and entanglement entropy, gravitation and holography}, Int. J. Mod. Phys. A {\bf 30}, 1530039 (2015).

\bibitem{ObregonCabo} N. Cabo Bizet, and O. Obreg\'on, {\it Generalized entanglement entropy and holography}, arXiv:1507.00779 [hep-th].

\bibitem{RT} S. Ryu, and T. Takayanagi, \textit{Aspects of holographic entanglement entropy}, JHEP 0608:045 (2006).

\bibitem{Michell} J. Michell, \textit{On the means of discovering the distance, magnitude \&c. of the fixed stars, in consequence of the diminution of the velocity of their light, ...}, Phil. Trans. R. Soc. London \textbf{74}, 35 (1784).

\bibitem{Laplace} P.-S. Laplace, \textit{Exposition de Syst\`eme du Monde} (Duprat, 1798).

\bibitem{Visser} M. Visser, ``Dirty black holes: Entropy as a surface term'', Phys. Rev. D\textbf{48}, 5697-5705 (1993); arXiv:hep-th/9307194.

\bibitem{JKM} T. Jacobson, G, Kang, and R.C. Myers, ``On black hole entropy'', Phys Rev D\textbf{49}, 6587-6598 (1994); arXiv:gr-qc/9312023.

\bibitem{Wald} R. Wald, Phys. Rev. D\textbf{48}, 3427 (1994); V. Iyer and R. Wald, Phys. Rev. D\textbf{50}, 846-864 (1994).

\bibitem{Vollik} D.N. Vollik, ``Noether charge and black hole entropy in modified theories of gravity'', Phys. Rev. D\textbf{76}, 124001 (2007); arXiv:0710.1859.
