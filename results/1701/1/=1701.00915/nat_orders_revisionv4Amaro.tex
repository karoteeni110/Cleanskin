...
%\textit{TUCS Dissertations} 110 (2009).

%\bibitem{HolLah}
%C. Hollanti, J. Lahtonen,
%A New Tool: Constructing STBCs from Maximal Orders in Central Simple Algebras, 
%\textit{Proceedings of the IEEE Information Theory Workshop}, Punta del Este (2006).

%\bibitem{HLRV}
%C. Hollanti, J. Lahtonen, K. Ranto, R. Vehkalahti, 
%Optimal Matrix Lattices for {MIMO} Codes from Division Algebras,
  %\textit{Proceedings of the 2006 IEEE International Symposium on Information Theory}, Seattle (2006).
  
%\bibitem{HL_aaecc}  
%C. Hollanti, H.-f. Lu, Normalized Minimum Determinant Calculation for Multi-Block and Asymmetric Space--Time Codes, \textit{Proceedings of the 17th Int. Conf. on Applied Algebra, Algebraic Computation, and Error Correcting Codes}, Bangalore (2007). 
 
%\bibitem{Kiran}
%T. Kiran, B. S. Rajan,
%STBC-Schemes with Nonvanishing Determinant for Certain Number of Antennas, 
%\textit{IEEE Transactions on Information Theory} 51 (8) (2005) pp. 2984--2992.

%\bibitem{Oggier_optimal}
%F. Oggier,
%On the Optimality of the Golden Code,
%\textit{Proceedings of the IEEE Information Theory Workshop}, Chengdu (2006).
  
%\bibitem{OVB}
%F.~Oggier, E.~Viterbo, J.-C. Belfiore,
% Cyclic Division Algebras: A Tool for Space--Time Coding,
%{\em Found. and Trends in Comm. and Inf.
%  Theory} 4 (1) (2007) pp. 1--95.

%\bibitem{OSI}
%OSI model, wikipedia article, https://en.wikipedia.org/wiki/OSI\_model, referred to Sep. 25 2015.
...
%\bibitem{ZT} L. Zheng; D. Tse, Diversity and multiplexing: a fundamental tradeoff in multiple-antenna channels,
%\textit{IEEE Transactions on Information Theory} 49  (5) (2003) pp. 1073--1096.
