...
\bibitem{book_comb_optimize} Papadimitriou, C.H., Steiglitz, K.:
...
\bibitem{kernel_Gaussian_journal}
Jian, B., Vemuri, B. C.:
`Robust point set registration using gaussian mixture models'.
\textit{IEEE Trans. Pattern Analysis and Machine Intelligence},
2011, \textbf{33}, pp. 1633-1645

\bibitem{GM_relax_label}
Zheng, Y., Doermann, D.:
`Robust point matching for nonrigid shapes by preserving local neighborhood structures'.
\textit{IEEE Trans. Pattern Analysis and Machine Intelligence},
2006, \textbf{28}, pp. 643-649

% \bibitem{game_theory_mismatch} Liu, H., Yan, S.:
% Common visual pattern discovery via spatially coherent correspondences,
% \textit{IEEE Conf. Computer Vision and Pattern Recognition}, 2010, pp.  1609-1616
% 
% \bibitem{geometric_blur} Berg, A.C., Berg, T.L., Malik, J.:
% `Shape matching and object recognition using low distortion correspondences',
% \textit{IEEE Conf. Computer Vision and Pattern Recognition}, 2005, pp. 26-33
% 
% \bibitem{convex_interior2} Li, H., Huang, J., Zhang, S., Huang, X.:
% `Optimal object matching via convexification and composition',
% \textit{IEEE International Conference on Computer Vision}, 2011, pp. 33-40



% \bibitem{matrix_calculus} Fackler, P.L.:
% `Notes on matrix calculus',
% \texttt{http://www4.ncsu.edu/$\sim$pfackler/Mat}, 2005
% 


% \bibitem{GM_path_follow} Mikhail Zaslavskiy, F.B., Vert, J.P.:
% `A path following algorithm for the graph matching problem',
% \textit{IEEE Trans. Pattern Analysis and Machine Intelligence}, 2009, \textbf{31}, pp. 2227-2242

% \bibitem{LAPJV} 
% R. Jonker and A. Volgenant.: 
% `A shortest augmenting path algorithm for dense and sparse linear assignment problems',
% \textit{Computing}, 1987, \textbf{38}, pp. 325-340

% Volgenant, A.:
% `Solving the k-cardinality assignment problem by transformation',
% \textit{European Journal of Operational Research}, 2004, \textbf{157}, pp. 322-331

% \bibitem{SC} Belongie, S., Malik, J., Puzicha, J.:
% `Shape matching and object recognition using shape contexts',
% \textit{IEEE Trans. Pattern Analysis and Machine Intelligence}, 2002, \textbf{24}, pp. 509-522
