...
\bibitem{BR} {\sc D.~Bao and C. Robles}, {\em  On Randers Spaces of Constant Flag Curvature}, Reports on Mathematical Physics, 51 (2003), 9--42.


%\bibitem{BaChSh00}
%{\sc D.~Bao, S.-S. Chern, and Z.~Shen}, {\em An Introduction to
%  {R}iemann-{F}insler geometry}, Graduate Texts in Mathematics,
...
\bibitem{BEE} {\sc J.K.~Beem, P.E.~Ehrlich, K.~Easley}, Global Lorentzian geometry. 
Second edition. Monographs and Textbooks in Pure and Applied Mathematics, 202. Marcel Dekker, Inc., New York, 1996.


 
  \bibitem{BerNik09}  {\sc V.~N.Berestovskii, Y.~G.Nikonorov},
      {\em Clifford-{W}olf homogeneous {R}iemannian manifolds}, J. Differential Geom., 82 (2009), 467--500.
     
     \bibitem{Berger} {\sc M.~Berger}, {\em Trois remarques sur les vari\'et\'es riemanniennes \`a
...
{\sc E.~Caponio, M.~A. Javaloyes and M.~S{\'a}nchez}, {\em {On the interplay
  ...
  \bibitem{CJSwind} {\sc E.~Caponio, M.~A. Javaloyes and M.~S{\'a}nchez},  {\em Wind Finslerian structures: from Zermelo's navigation to the causality of spacetimes},  arXiv:1407.5494v4 [math.DG].
...
%\bibitem{ChSh05}
%{\sc S.-S. Chern and Z.~Shen}, {\em Riemann-{F}insler geometry}, vol.~6 of
%  Nankai Tracts in Mathematics, World Scientific Publishing Co. Pte. Ltd.,
%  Hackensack, NJ, 2005.
%
%
%
%
%\bibitem{CuSh09}
%{\sc N.~Cui and Y.-B. Shen}, {\em Projective change between two classes of
%  {$(\alpha,\beta)$}-metrics}, Differential Geom. Appl., 27 (2009),
%  pp.~566--573.
  
  \bibitem{GHWW} {\sc G.~Gibbons, C.~Herdeiro, C.~Warnick and M.~Werner: {\em Stationary metrics
and optical Zermelo-Randers-Finsler geometry}}, Phys. Rev. D, 79
(2009), 044022.
  
  \bibitem{GilLli} {\sc O.~Gil-Medrano and E.~Llinares-Fuster}, {\em Second variation of
Volume and Energy of vector fields. Stability of Hopf vector fields,}  Math.
Ann., 320 (2001), 531-545.

\bibitem{FHS} {\sc J.L.~Flores, J.~Herrera, M.~S\'anchez}, 
...
\bibitem{JV} {\sc M.~A. Javaloyes, H.~Vit\'orio}, {\em Zermelo navigation in pseudo-Finsler metrics}, 	arXiv:1412.0465 [math.DG].


\bibitem{Kne45} {\sc M.~S. Knebelman}, {\em On the equations of motion in a Riemann space}, 
Bull. Amer. Math. Soc. 51, (1945), pp. 682--685


\bibitem{KneYan60} {\sc M.~S. Knebelman and K.~Yano},
...
%\bibitem{Kro59}
%{\sc V.~K. Kropina}, {\em On projective {F}insler spaces with a metric of some
%  special form}, Naucn. Dokl. Byss. Skoly, 2 (1959), pp.~38--42.
%
%\bibitem{LiSh07}
%{\sc B.~Li and Z.~Shen}, {\em On a class of projectively flat {F}insler metrics
%  with constant flag curvature}, Internat. J. Math., 18 (2007), pp.~749--760.
%  
%
%
%
%\bibitem{MSS10}
%{\sc I.~M. Masca, V.~S. Sabau, and H.~Shimada}, {\em Reversible geodesics for
%  {$(\alpha,\beta)$}-metrics}, Internat. J. Math., 21 (2010), pp.~1071--1094.

\bibitem{MinSan}{\sc E. Minguzzi, M. S\'anchez}, {\em The causal hierarchy of spacetimes}, in: Recent developments in pseudo-Riemannian geometry, 299--358, ESI Lect. Math. Phys., Eur. Math. Soc., Zürich, 2008.


\bibitem{Nomizu} {\sc K. Nomizu}, {\em 
...
%\bibitem{Per08}
%{\sc V.~Perlick}, {\em Fermat principle in {F}insler spacetimes}, Gen.
%  Relativity Gravitation, 38 (2006), pp.~365--380.
%
%\bibitem{Ran41}
%{\sc G.~Randers}, {\em On an asymmetrical metric in the fourspace of general
%  relativity}, Phys. Rev. (2), 59 (1941), pp.~195--199.
  
 \bibitem{RomSan02} {\sc A.~Romero and M.~S{\'a}nchez},
      {\em Projective vector fields on {L}orentzian manifolds},
  Geom. Dedicata, 93 (2002), 95--105.
 

%\bibitem{SaShi}
%{\sc V.~S. Sabau and H.~Shimada}, {\em Classes of {F}insler spaces with
%  {$(\alpha,\beta)$}-metrics}, Rep. Math. Phys., 47 (2001), pp.~31--48.

\bibitem{SaFIELDS} {\sc M. S\'anchez}, {\em On the completeness of trajectories for some mechanical systems}, in: {\em Geometry, mechanics, and dynamics}, Fields Inst. Commun., 73, Springer, New York (2015), pp.~343--372;
 arxiv:
...
%\bibitem{shen2001}
%{\sc Z.~Shen}, {\em Differential geometry of spray and {F}insler spaces},
%  Kluwer Academic Publishers, Dordrecht, 2001.
%
%\bibitem{Sh01}
%{\sc Z.~Shen},  {\em Lectures on
%  {F}insler geometry}, World Scientific Publishing Co., Singapore, 2001.
%
%\bibitem{ShCi08}
%{\sc Z.~Shen and G.~Civi~Yildirim}, {\em On a class of projectively flat
%  metrics with constant flag curvature}, Canad. J. Math., 60 (2008),
%  pp.~443--456.
%
%\bibitem{SSI08}
%{\sc H.~Shimada, S.~V. Sabau, and R.~S. Ingarden}, {\em The
%  {$(\alpha,\beta)$}-metric for {F}insler space and its role in
%  thermodynamics}, Bull. Soc. Sci. Lett. \L \'od\'z S\'er. Rech. D\'eform., 57
%  (2008), pp.~25--38.

\bibitem{TASHIRO} {\sc Y.~Tashiro}, {\em Complete {R}iemannian manifolds and some vector fields}, Trans. Amer. Math. Soc., 117 (2965), 251--275.

%\bibitem{Urbantke} {\sc H.~K. Urbantke},
%     {\em The {H}opf fibration---seven times in physics},
%  J. Geom. Phys., 46, (2003), 125--150.
     

\bibitem{Wieg} {\sc G.~Wiegmink}, {\em  Total bending of vector fields on the Sphere $S^3$},  Differential Geom. Appl., 6 (1996), 219--236.

\bibitem{YT} {\sc K. Yano and T. Nagano}, {\em
...
%\bibitem{Zhou10}
%{\sc L.~Zhou}, {\em A local classification of a class of {$(\alpha,\beta)$}
%  metrics with constant flag curvature}, Differential Geom. Appl., 28 (2010),
%  pp.~170--193.
