...
\bibitem{ADvM} M. Abry, J.J. Dijkstra, and J. van Mill, On one-point connectifications. \textit{Topology Appl.} \textbf{154} (2007), no. 3, 725--733.

\bibitem{A} P. Alexandroff, \"{U}ber die Metrisation der im Kleinen kompakten topologischen R\"{a}ume. (German) \textit{Math. Ann.} \textbf{92} (1924), no. 3--4, 294--301.

\bibitem{E} R. Engelking, \textit{General Topology}. Second edition. Sigma Series in Pure Mathematics, 6. Heldermann Verlag, Berlin, 1989.

\bibitem{Kn} B. Knaster, Sur un probl\`{e}me de P. Alexandroff. \textit{Fund. Math.} \textbf{33} (1945), 308--313.

\bibitem{Ko} M.R. Koushesh, One-point connectifications. \textit{J. Aust. Math. Soc.} \textbf{99} (2015), no. 1, 76--84.
