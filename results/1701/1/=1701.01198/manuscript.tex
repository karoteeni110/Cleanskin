...
\bibitem{gradl2006parallelising}
\bibinfo{author}{Gradl, T.}, \bibinfo{author}{Sp{\"o}rl, A.},
  \bibinfo{author}{Huckle, T.}, \bibinfo{author}{Glaser, S.~J.} \&
  \bibinfo{author}{Schulte-Herbr{\"u}ggen, T.}
\newblock \bibinfo{title}{Parallelising matrix operations on clusters for an
  optimal control-based quantum compiler}.
\newblock In \emph{\bibinfo{booktitle}{European Conference on Parallel
  Processing}}, \bibinfo{pages}{751--762} (\bibinfo{organization}{Springer},
  \bibinfo{year}{2006}).
...
\bibitem{brif2010control}
\bibinfo{author}{Brif, C.}, \bibinfo{author}{Chakrabarti, R.} \&
  \bibinfo{author}{Rabitz, H.}
\newblock \bibinfo{title}{Control of quantum phenomena: past, present and
  future}.
\newblock \emph{\bibinfo{journal}{New J. Phys.}} \textbf{\bibinfo{volume}{12}},
  \bibinfo{pages}{075008} (\bibinfo{year}{2010}).

\bibitem{boykin2002algorithmic}
\bibinfo{author}{Boykin, P.~O.}, \bibinfo{author}{Mor, T.},
  \bibinfo{author}{Roychowdhury, V.}, \bibinfo{author}{Vatan, F.} \&
  \bibinfo{author}{Vrijen, R.}
\newblock \bibinfo{title}{Algorithmic cooling and scalable nmr quantum
  computers}.
\newblock \emph{\bibinfo{journal}{Proc. Natl. Acad. Sci. USA}}
  \textbf{\bibinfo{volume}{99}}, \bibinfo{pages}{3388--3393}
  (\bibinfo{year}{2002}).

\bibitem{baugh2005experimental}
\bibinfo{author}{Baugh, J.}, \bibinfo{author}{Moussa, O.},
  \bibinfo{author}{Ryan, C.~A.}, \bibinfo{author}{Nayak, A.} \&
  \bibinfo{author}{Laflamme, R.}
\newblock \bibinfo{title}{Experimental implementation of heat-bath algorithmic
  cooling using solid-state nuclear magnetic resonance}.
\newblock \emph{\bibinfo{journal}{Nature}} \textbf{\bibinfo{volume}{438}},
  \bibinfo{pages}{470--473} (\bibinfo{year}{2005}).

\bibitem{souza2011experimental}
\bibinfo{author}{Souza, A.~M.}, \bibinfo{author}{Zhang, J.},
  \bibinfo{author}{Ryan, C.~A.} \& \bibinfo{author}{Laflamme, R.}
\newblock \bibinfo{title}{Experimental magic state distillation for
  fault-tolerant quantum computing}.
\newblock \emph{\bibinfo{journal}{Nat. Commun.}} \textbf{\bibinfo{volume}{2}},
  \bibinfo{pages}{169} (\bibinfo{year}{2011}).
...
\newblock \bibinfo{title}{Quantum cryptography: Public key distribution and
  coin tossing}.
\newblock In \emph{\bibinfo{booktitle}{International Conference on Computer
  System and Signal Processing, IEEE, 1984}}, \bibinfo{pages}{175--179}
  (\bibinfo{year}{1984}).

\bibitem{khaneja2005optimal}
\bibinfo{author}{Khaneja, N.}, \bibinfo{author}{Reiss, T.},
  \bibinfo{author}{Kehlet, C.}, \bibinfo{author}{Schulte-Herbr{\"u}ggen, T.} \&
  \bibinfo{author}{Glaser, S.~J.}
\newblock \bibinfo{title}{Optimal control of coupled spin dynamics: design of
  nmr pulse sequences by gradient ascent algorithms}.
\newblock \emph{\bibinfo{journal}{J. Magn. Reson.}}
  \textbf{\bibinfo{volume}{172}}, \bibinfo{pages}{296--305}
  (\bibinfo{year}{2005}).

\bibitem{ryan2008liquid}
...
\bibitem{zhang2011coherent}
\bibinfo{author}{Zhang, Y.}, \bibinfo{author}{Ryan, C.~A.},
  \bibinfo{author}{Laflamme, R.} \& \bibinfo{author}{Baugh, J.}
\newblock \bibinfo{title}{Coherent control of two nuclear spins using the
  anisotropic hyperfine interaction}.
\newblock \emph{\bibinfo{journal}{Phys. Rev. Lett.}}
  \textbf{\bibinfo{volume}{107}}, \bibinfo{pages}{170503}
  (\bibinfo{year}{2011}).

\bibitem{waldherr2014quantum}
\bibinfo{author}{Waldherr, G.} \emph{et~al.}
\newblock \bibinfo{title}{Quantum error correction in a solid-state hybrid spin
  register}.
\newblock \emph{\bibinfo{journal}{Nature}} \textbf{\bibinfo{volume}{506}},
  \bibinfo{pages}{204--207} (\bibinfo{year}{2014}).

\bibitem{dolde2014high}
\bibinfo{author}{Dolde, F.} \emph{et~al.}
\newblock \bibinfo{title}{High-fidelity spin entanglement using optimal
  control}.
\newblock \emph{\bibinfo{journal}{Nat. Commun.}} \textbf{\bibinfo{volume}{5}}
  (\bibinfo{year}{2014}).

\bibitem{motzoi2009simple}
\bibinfo{author}{Motzoi, F.}, \bibinfo{author}{Gambetta, J.},
  \bibinfo{author}{Rebentrost, P.} \& \bibinfo{author}{Wilhelm, F.~K.}
\newblock \bibinfo{title}{Simple pulses for elimination of leakage in weakly
  nonlinear qubits}.
\newblock \emph{\bibinfo{journal}{Phys. Rev. Lett.}}
  \textbf{\bibinfo{volume}{103}}, \bibinfo{pages}{110501}
  (\bibinfo{year}{2009}).

\bibitem{egger2013optimized}
\bibinfo{author}{Egger, D.~J.} \& \bibinfo{author}{Wilhelm, F.~K.}
\newblock \bibinfo{title}{Optimized controlled-z gates for two superconducting
  qubits coupled through a resonator}.
\newblock \emph{\bibinfo{journal}{Supercond. Sci. Technol.}}
  \textbf{\bibinfo{volume}{27}}, \bibinfo{pages}{014001}
  (\bibinfo{year}{2013}).

\bibitem{nebendahl2009optimal}
\bibinfo{author}{Nebendahl, V.}, \bibinfo{author}{H{\"a}ffner, H.} \&
  \bibinfo{author}{Roos, C.}
\newblock \bibinfo{title}{Optimal control of entangling operations for
  trapped-ion quantum computing}.
\newblock \emph{\bibinfo{journal}{Phys. Rev. A}} \textbf{\bibinfo{volume}{79}},
  \bibinfo{pages}{012312} (\bibinfo{year}{2009}).
...
\bibitem{li2016physical}
\bibinfo{author}{Li, J.}, \bibinfo{author}{Yang, X.}, \bibinfo{author}{Peng,
  X.} \& \bibinfo{author}{Sun, C.-P.}
\newblock \bibinfo{title}{Hybrid quantum-classical approach to quantum optimal
  control}.
\newblock \emph{\bibinfo{journal}{Phys. Rev. Lett.}}
  \textbf{\bibinfo{volume}{118}}, \bibinfo{pages}{150503}
  (\bibinfo{year}{2017}).

\bibitem{rebentrost2016quantum}
\bibinfo{author}{Rebentrost, P.}, \bibinfo{author}{Schuld, M.},
  \bibinfo{author}{Petruccione, F.} \& \bibinfo{author}{Lloyd, S.}
\newblock \bibinfo{title}{Quantum gradient descent and newton's method for
  constrained polynomial optimization}.
\newblock \emph{\bibinfo{journal}{arXiv:1612.01789}}  (\bibinfo{year}{2016}).

\bibitem{vijay2012stabilizing}
\bibinfo{author}{Vijay, R.} \emph{et~al.}
\newblock \bibinfo{title}{Stabilizing rabi oscillations in a superconducting
  qubit using quantum feedback}.
\newblock \emph{\bibinfo{journal}{Nature}} \textbf{\bibinfo{volume}{490}},
  \bibinfo{pages}{77--80} (\bibinfo{year}{2012}).

\bibitem{hirose2016coherent}
\bibinfo{author}{Hirose, M.} \& \bibinfo{author}{Cappellaro, P.}
\newblock \bibinfo{title}{Coherent feedback control of a single qubit in
  diamond}.
\newblock \emph{\bibinfo{journal}{Nature}} \textbf{\bibinfo{volume}{532}},
  \bibinfo{pages}{77--80} (\bibinfo{year}{2016}).

\bibitem{supple}
\bibinfo{title}{See supplemental information} .

\bibitem{lu2015experimental}
...
\bibinfo{author}{Daley, A.~J.}
\newblock \bibinfo{title}{Quantum trajectories and open many-body quantum
  systems}.
\newblock \emph{\bibinfo{journal}{Adv. Phys.}} \textbf{\bibinfo{volume}{63}},
  \bibinfo{pages}{77--149} (\bibinfo{year}{2014}).

\bibitem{mascarenhas2015matrix}
\bibinfo{author}{Mascarenhas, E.}, \bibinfo{author}{Flayac, H.} \&
  \bibinfo{author}{Savona, V.}
\newblock \bibinfo{title}{Matrix-product-operator approach to the
  nonequilibrium steady state of driven-dissipative quantum arrays}.
\newblock \emph{\bibinfo{journal}{Phys. Rev. A}} \textbf{\bibinfo{volume}{92}},
  \bibinfo{pages}{022116} (\bibinfo{year}{2015}).

\bibitem{lloyd2014information}
\bibinfo{author}{Lloyd, S.} \& \bibinfo{author}{Montangero, S.}
\newblock \bibinfo{title}{Information theoretical analysis of quantum optimal
  control}.
\newblock \emph{\bibinfo{journal}{Phys. Rev. Lett.}}
  \textbf{\bibinfo{volume}{113}}, \bibinfo{pages}{010502}
  (\bibinfo{year}{2014}).
...
\newblock \emph{\bibinfo{journal}{arXiv:1203.5813}}  (\bibinfo{year}{2012}).

\bibitem{wang2017high}
\bibinfo{author}{Wang, H.} \emph{et~al.}
\newblock \bibinfo{title}{High-efficiency multiphoton boson sampling}.
\newblock \emph{\bibinfo{journal}{Nat. Photon.}} \textbf{\bibinfo{volume}{11}},
  \bibinfo{pages}{361--365} (\bibinfo{year}{2017}).

\bibitem{dive2017situ}
\bibinfo{author}{Dive, B.}, \bibinfo{author}{Pitchford, A.},
  \bibinfo{author}{Mintert, F.} \& \bibinfo{author}{Burgarth, D.}
\newblock \bibinfo{title}{In situ upgrade of quantum simulators to universal
  computers}.
\newblock \emph{\bibinfo{journal}{arXiv:1701.01723}}  (\bibinfo{year}{2017}).

\bibitem{song201710}
\bibinfo{author}{Song, C.} \emph{et~al.}
\newblock \bibinfo{title}{10-qubit entanglement and parallel logic operations
  with a superconducting circuit}.
\newblock \emph{\bibinfo{journal}{arXiv:1703.10302}}  (\bibinfo{year}{2017}).
...
\bibitem{johnson2008cyclobutanone}
