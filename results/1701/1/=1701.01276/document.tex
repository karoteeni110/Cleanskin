...
\bibitem{anderson_reflections_1991}
J.~R. Anderson and L.~J. Schooler.
\newblock Reflections of the environment in memory.
\newblock {\em Psychological Science}, 2(6):396--408, 1991.

\bibitem{campos2014time}
...
\newblock {\em User Modeling and User-Adapted Interaction}, 24(1-2):67--119,
  2014.

\bibitem{clauset2009power}
A.~Clauset, C.~R. Shalizi, and M.~E. Newman.
\newblock Power-law distributions in empirical data.
\newblock {\em SIAM review (SIREV)}, 51(4):661--703, 2009.

\bibitem{cress2013collective}
...
\newblock {\em Recommender Systems \& the Social Web}, 2009.
...
\bibitem{jaschke2008tag}
R.~J{\"a}schke, L.~Marinho, A.~Hotho, L.~Schmidt-Thieme, and G.~Stumme.
\newblock Tag recommendations in social bookmarking systems.
\newblock {\em AI Communications}, 21(4):231--247, 2008.

\bibitem{jeon2014hashtag}
...
\bibitem{krestel2012personalized}
R.~Krestel and P.~Fankhauser.
\newblock Personalized topic-based tag recommendation.
\newblock {\em Neurocomputing}, 76(1):61--70, 2012.

\bibitem{krestel2009latent}
...
\bibitem{marinho2008collaborative}
...
\newblock {\em Applied Cognitive Psychology}, 29(1):32--48, 2015.
...
\bibitem{small2011hashtag}
T.~A. Small.
\newblock What the hashtag? a content analysis of canadian politics on twitter.
\newblock {\em Information, Communication \& Society}, 14(6):872--895, 2011.
...
\bibitem{zangerle2011recommending}
...
\bibitem{zangerle2013impact}
E.~Zangerle, W.~Gassler, and G.~Specht.
\newblock On the impact of text similarity functions on hashtag recommendations
  in microblogging environments.
\newblock {\em Social Network Analysis and Mining}, 3(4):889--898, 2013.

\bibitem{zhang2012integrating}
