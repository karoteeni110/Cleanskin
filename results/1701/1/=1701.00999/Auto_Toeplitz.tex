...
\newblock {\em Duke Math. J. }, 30:605--614, 1963.
...
\bibitem{BoyleLindRudolph}
M. Boyle, D. Lind, and D. Rudolph.
\newblock The automorphism group of a shift of finite type.
\newblock  {\em Trans. Amer. Math. Soc.} 306: 71--114, 1988.

\bibitem{BulatekK} W. Bulatek and J. Kwiatkowski.
\newblock Strictly ergodic Toeplitz flows with positive entropies and trivial centralizers.
\newblock {\em Studia Mathematica} 103:133--142, 1992. 

\bibitem{CK} J. Cassaigne and J. Karhum\"aki.
\newblock Toeplitz Words, Generalized Periodicity and Periodically Iterated Morphisms.
\newblock  {\em European J. Combin.} 18:497--510, 1997.

\bibitem{CortezPetite:2008} M.-I. Cortez and S. Petite.
\newblock G-odometers and their almost one-to-one extensions.
\newblock {\em J. Lond. Math. Soc.} 78(2):1--20,  2008. 

\bibitem{CovenQuasYassawi} E. Coven, A. Quas, and R. Yassawi.
\newblock Computing automorphism groups of shifts using atypical equivalence classes.
\newblock {\em  Discrete Anal.} 2016, Paper No. 611, 28 pp.

\bibitem{CyrKra} V. Cyr and B. Kra.
...
\bibitem{CyrKra2} V. Cyr and B. Kra.
\newblock The automorphism group of a shift of linear growth.
\newblock {\em Forum Math. Sigma} 3:e5, 27, 2015.

\bibitem{CyrKra3} V. Cyr and B. Kra.
\newblock The automorphism group of a minimal shift of stretched exponential growth.
\newblock {\em J. Mod. Dyn.}  10:483 --495, 2016. 

\bibitem{CyrKra4} V. Cyr, J. Franks, and B. Kra.
\newblock The spacetime of a shift automorphism.
\newblock 2016, { arXiv:1610.07923}. 

\bibitem{CyrKra5} V, Cyr, J. Franks, B, Kra, and S, Petite.
\newblock Distortion and the automorphism group of a shift.
\newblock 2016, { arXiv:1611.05913}.

\bibitem{DonosoDurandMaassPetite} S. Donoso , F. Durand, A. Maass, and S. Petite.
\newblock On automorphism groups of low complexity subshifts. 
\newblock {\em Ergodic Theory and Dynam. Systems}  36:64--95, 2016. 

\bibitem{Downarowicz:2005} T. Downarowicz.
\newblock Survey of odometers and Toeplitz flows in Algebraic and topological dynamics.
\newblock {\em Contemp. Math.} {385}:7--37, 2005.

\bibitem{DownarowiczKwiatkowskiLacroix:1995} T. Downarowicz, J. Kwiatkowski, and Y. Lacroix.
\newblock A criterion for Toeplitz flows to be topologically isomorphic and applications.
\newblock {\em Colloq. Mathematicum} 68:219--228, 1995.

\bibitem{Olli} J. Olli.
\newblock Endomorphisms of Sturmian systems and the discrete chair substitution tiling system.
\newblock {\em Discrete Contin. Dyn. Syst.} {33}:4173--4186, 2013.

\bibitem{QZ} A. Quas and L. Zamboni.
\newblock Periodicity and local complexity.
\newblock {\em Theoret. Comput. Sci.} {319}:229--240, 2004. 	


\bibitem{SaloTorma} V. Salo and I. T\"orm\"a.
\newblock Block maps between primitive uniform and Pisot substitutions.
\newblock  {\em Ergodic Theory and Dynam. Systems} {35}:2292--2310, 2015.
...
\bibitem{Williams84} S. Williams.
\newblock Toeplitz minimal flows which are not uniquely ergodic.
\newblock {\em  Z. Wahrsch. Verw. Gebiete} {67}:95--107, 1984. 		
