...
%[arXiv:hep-ph/0309177].
%%CITATION = HEP-PH 0309177;%%
...
\bibitem{Stasto:2000er}
A.~M.~Sta\'sto, K.~Golec-Biernat and J.~Kwiecinski,
%``Geometric scaling for the total gamma* p cross-section in the low x
%region,''
Phys.\ Rev.\ Lett.\  {\bf 86}, 596 (2001).
%[arXiv:hep-ph/0007192].
%%CITATION = HEP-PH 0007192;%%


\bibitem{Freund:2002ux}
...
\bibitem{Armesto_scal}
N.~Armesto, C.~A.~Salgado and U.~A.~Wiedemann, Phys.\ Rev.\ Lett.\  {\bf 94}, 022002 (2005).
%%    
\bibitem{GBW} K. Golec-Biernat and  M. W\"usthoff,  Phys. Rev. D {\bf 59}, 014017 (1999),  {\it ibid.} {\bf 60} 114023 (1999).

\bibitem{Kowalski:2006hc} 
...
\bibitem{EICs} A. Accardi {\it et al.}, Eur. Phys. J {\bf A52}, 268 (2016);  J.~B.~Dainton, M.~Klein, P.~Newman, E.~Perez and F.~Willeke,
...
\bibitem{Glauber1}  G. Sampaio dos Santos and M.V.T. Machado, J. Phys. G {\bf 42}, 105001 (2015).

\bibitem{Glauber2} G. Sampaio dos Santos and M.V.T. Machado, Phys. Rev. C {\bf 91}, 025203 (2015).

\bibitem{BC} M.Block and R.N. Cahn, Rev. Mod. Phys. {\bf 57}, 563 (1985).

\bibitem{GLM} E. Gotsman, E. Levin, M. Lublinsky and U. Maor, 	Eur. Phys. J. {\bf C27}, 411 (2003).

\bibitem{Amir} A. H. Rezaeian and I. Schmidt,  Phys. Rev.  {\bf D 88}, 074016 (2013).

\bibitem{McDermott} M. McDermott, L. Frankfurt, V. Guzey and M. Strikman, Eur. Phys. J. {\bf C16}, 641 (2000).
...
\bibitem{KNNZ} B.Z.Kopeliovich, J.Nemchick, N.N.Nikolaev, and B.G.Zakharov, 	Phys. Lett. {\bf B324}, 469 (1994).
...
\bibitem{minpack} 
  J.~J.~Mor\'e, B.~S.~Garbow and K.~E.~Hillstrom, %User Guide for MINPACK-1, 
  Argonne National Laboratory Report ANL-80-74 (1980).

\bibitem{prazlach} M. Praszalowicz and A. Francuz, Phys. Rev. D {\bf 92}, 074036 (2016); L. McLerran and M. Praszalowicz, Phys. Lett. B {\bf 741}, 246  (2015). 

\bibitem{prazlapf} C. Klein-B\"{o}sing and L. McLerran, Phys. Lett. B {\bf 734 }, 282 (2014).

\bibitem{Capua} M. Capua [H1 and ZEUS Collaborations], Proceedings of the 3rd International Workshop on Multiple Partonic Interactions at the LHC (MPI@LHC 2011) : Hamburg, Germany, 21-25 Nov 2011, arXiv:1202.2828 [hep-ex].

\bibitem{Guzey:2013xba} 
  V.~Guzey, E.~Kryshen, M.~Strikman and M.~Zhalov,  Phys.  Lett.  B {\bf 726}, 290 (2013).

\bibitem{Contreras:2016pkc} 
  J.~G.~Contreras,   Phys.  Rev.  C {\bf 96}, 015203  (2017).

\bibitem{Guzey:2016piu} 
  V.~Guzey, E.~Kryshen and M.~Zhalov,   Phys. Rev. C  {\bf 93}, 055206 (2016).

\bibitem{Frankfurt:2015cwa} 
