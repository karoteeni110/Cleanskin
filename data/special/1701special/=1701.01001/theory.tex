...
\begin{enumerate}[(i)]
    ...
    The process $\{Ê\perblock_n \}_{n \in \zset}$, where $\perblock_n \eqdef \chunk{\per}{n r}{(n + 1)r - 1}$, is ergodic and such that $\prob(\bar{\per}_0 \in K) > 2/3$.
