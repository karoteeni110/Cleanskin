...
%\usepackage{cite}[1]-[4]
\usepackage{amsmath,amssymb,amsthm}  %~\\可用于在定理及证明等坏境下的换行
\usepackage{paralist}%[flushleft] 使列表左对齐的命令
%\usepackage{ntheorem}  可以定义得到一些新的定理坏境的命令
...
%\caption{The proposed algorithm}             %算法的标题
%\label{alg_THong}                  %给算法一个标签，这样方便在文中对算法的引用
%\begin{algorithmic}[1]
%\REQUIRE ~\\
...
\newcommand{\xiaochu}{\fontsize{36pt}{\baselineskip}\selectfont} % 字号设置
\newcommand{\yihao}{\fontsize{28pt}{\baselineskip}\selectfont}      % 字号设置
\newcommand{\erhao}{\fontsize{21pt}{\baselineskip}\selectfont}      % 字号设置
\newcommand{\xiaoer}{\fontsize{18pt}{\baselineskip}\selectfont}  % 字号设置
\newcommand{\sanhao}{\fontsize{15.75pt}{\baselineskip}\selectfont}  % 字号设置
\newcommand{\sihao}{\fontsize{14pt}{16.8pt}\selectfont}      % 字号设置
\newcommand{\xiaosi}{\fontsize{12pt}{14.4pt}\selectfont}  % 字号设置
\newcommand{\wuhao}{\fontsize{10.5pt}{12.6pt}\selectfont}    % 字号设置
\newcommand{\xiaowu}{\fontsize{9pt}{10.8pt}\selectfont}   % 字号设置
\newcommand{\liuhao}{\fontsize{7.875pt}{9pt}\selectfont}  % 字号设置
\newcommand{\xiaoliu}{\fontsize{7pt}{7.8pt}\selectfont}  % 字号设置
\newcommand{\qihao}{\fontsize{6pt}{6.6pt}\selectfont}   % 字号设置
\newcommand{\bahao}{\fontsize{5pt}{6pt}\selectfont}   % 字号设置
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
